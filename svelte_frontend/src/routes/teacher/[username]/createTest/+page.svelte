<script lang="ts">
    ...
    async function addTest(retry = true) {
        ...
        if (response.ok) {
            ...
            error = errorData.detail || "Nepavyko pridėti testo!";
        }
    }
...
<div class="form-container">
    <h2 class="form-header">Naujo testo kūrimas</h2>
    ...
    <div class="button-container">
        ...
        <button class="button submit" on:click={addTest}>Išsaugoti testą</button>
    </div>
